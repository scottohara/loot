...
function createSchedule(
	props: Partial<Schedule> & { transaction_date: Date } = {
...
export function createScheduledBasicTransaction(
	props: Partial<ScheduledBasicTransaction> = {},
): ScheduledBasicTransaction {
	return Object.assign(createBasicTransaction(), createSchedule(), props);
}

export function createScheduledTransferTransaction(
	props: Partial<ScheduledTransferTransaction>,
): ScheduledTransferTransaction {
	return Object.assign(createTransferTransaction(), createSchedule(), props);
}

export function createScheduledSplitTransaction(
	props: Partial<ScheduledSplitTransaction> = {},
): ScheduledSplitTransaction {
	return Object.assign(createSplitTransaction(), createSchedule(), props);
}

export function createScheduledSecurityHoldingTransaction(
	props: Partial<ScheduledSecurityHoldingTransaction>,
): ScheduledSecurityHoldingTransaction {
