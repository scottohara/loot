...
export default class OgModalErrorServiceMockProvider
	implements Mock<OgModalErrorServiceMock>
{
	public constructor(
		private readonly ogModalErrorService: OgModalErrorServiceMock = {
