(function() {
	...
	describe("transactionEditController", function() {
		...
		beforeEach(inject(function(_controllerTest_, _$modalInstance_, _$timeout_, _payeeModel_, _securityModel_, _categoryModel_, _accountModel_, _transactionModel_, _transaction_) {
		...
		describe("invalidateCaches", function() {
			...
			it("should eventually be fulfilled", function() {
				transactionEditController.invalidateCaches(saved).should.be.fulfilled;
			});
		});
		...
		describe("updateLruCaches", function() {
			...
			it("should eventually be fulfilled", function() {
				transactionEditController.updateLruCaches(data).should.be.fulfilled;
			});
		});
