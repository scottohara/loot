...
RSpec.configure do |config|
	...
	config.before :suite do
		...
		FactoryBot.lint(FactoryBot.factories.reject { |factory| %i[transaction_header payee_transaction_header security_transaction_header transaction_account].include? factory.name })
	end
